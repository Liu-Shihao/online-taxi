package com.lsh.sms.service.impl;

import com.alibaba.fastjson.JSONObject;
import com.lsh.sms.constant.SmsStatusEnum;
import com.lsh.sms.dao.ServiceSmsRecordDao;
import com.lsh.sms.dao.ServiceSmsTemplateCustomDao;
    ...
    public ResponseResult sendSms(SmsSendRequest request) {
        ...
        for (String phoneNumber : request.getReceivers()) {
            ...
            for (SmsTemplateDto template : templates) {
                // 从DB加载模板内容至缓存
                log.info("发送验证码模板ID:{}",template.getId());
